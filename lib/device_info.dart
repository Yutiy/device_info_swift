...
class DeviceInfo {
  ...
  static const MethodChannel _channel = const MethodChannel('plugins.yutiy/device_info');
  ...
  Future<AndroidDeviceInfo> get androidInfo async =>
      _cachedAndroidDeviceInfo ??= AndroidDeviceInfo._fromMap(await _channel
  ...
  Future<IosDeviceInfo> get iosInfo async =>
      _cachedIosDeviceInfo ??= IosDeviceInfo._fromMap(
          await _channel.invokeMapMethod<String, dynamic>('getIosDeviceInfo'));
}
